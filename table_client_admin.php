...
if (isset($_GET["cari"])) {
  ...
  $query  = "SELECT * FROM reseller INNER JOIN client ON reseller.username = client.id_reseller LIKE '%$nama_client%' ORDER BY client.nama_client ASC";
...
<nav id="navbar-main" class="navbar is-fixed-top">
  <div class="navbar-brand">
    ...
    <div class="navbar-item">
      <div class="control">
        <form id="search" action="table_client_admin.php" method="get">
      ...
      <div class="card-content">
        <table>
          ...
          <tr>
            ...
            <?php
           $query = "SELECT * FROM reseller INNER JOIN client ON reseller.username = client.id_reseller  ORDER BY reseller.nama_instansi ASC";
