...
<?php
        $result = mysqli_query($conn, "SELECT * FROM  `client`  WHERE client.username='$_SESSION[username]'");
          ...
          <form action="" method="POST">
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="nama_instansi" type="text" placeholder="Global Media Data Prima" value="<?php echo $data['nama_client']; ?>">
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              <label class="label">Alamat Client</label>
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="alamat_instansi" type="text" placeholder="Alamat" value="<?php echo $data['alamat_client']; ?>">
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              <label class="label">No HP Client</label>
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="no_wa_reseller" type="text" placeholder="NNomor HP" value="<?php echo $data['no_wa_client']; ?>">
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="paket_client" type="number" value="<?php echo $data['paket_client'] ?>" readonly>
                  </div>
                  <p class="help">Perubahan Paket Hanya Dapat Dilakukan Oleh Reseller</p>
                </div>
              </div>
            </div>
            <hr>
