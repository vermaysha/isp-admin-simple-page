 ...
 if (isset($_POST["submit1"])) {
   ...
   if ($_POST["submit1"]=="Edit") {
    ...
    $nama_instansi = mysqli_real_escape_string($conn,$nama_instansi);
     ...
     $no_wa_reseller     = $data["no_wa_instansi"];
     $paket_reseller     = $data["paket_reseller"];
   ...
   mysqli_free_result($result);
    ...
    $paket_reseller       = htmlentities(strip_tags(trim($_POST["paket_reseller"] ?? '')));
   ...
   if (empty($nama_instansi)) {
     $pesan_error .= "Nama Instansi belum diisi <br>";
   }
   ...
   if (($pesan_error === "") AND ($_POST["submit"]=="Update Data")) {
     ...
     $paket_reseller         = mysqli_real_escape_string($conn,$paket_reseller);
     $username               = mysqli_real_escape_string($conn,$username);
     $password               = mysqli_real_escape_string($conn,$password);
     $level                  = mysqli_real_escape_string($conn,$level);

     $query = "UPDATE `reseller` SET `username`='$username',`nama_instansi`='$nama_instansi',`nama_pemilik`='$nama_pemilik',`email_reseller`='$email_reseller',`alamat_instansi`='$alamat_instansi',`no_wa_reseller`='$no_wa_reseller',`paket_reseller`='$paket_reseller' WHERE username = '$username'";

     $result = mysqli_query($conn, $query);

     if($result) {
      $query2 = "UPDATE `login` SET `username`='$username',`password`='$password',`level`='reseller' WHERE username = '$username' ";
