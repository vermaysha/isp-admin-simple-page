...
if (isset($_POST["hapus"])) {
  ...
  if($hasil_query) {
    ...
    $pesan = "Client dengan Nama = \"<b>$username</b>\" sudah berhasil di hapus";
    $pesan = urlencode($pesan);
      header("Location: table_client_reseller.php?pesan={$pesan}");
  }
  else {
          ...
          <tr>
            ...
            <td class="actions-cell">
              ...
              <form action="client_info.php" method="post" >
                ...
                &nbsp;
                <form action="edit_data_client.php" method="post" >
                <input type="hidden" name="username" value="<?php echo "$data[username]"; ?>" >
