...
if (isset($_POST["submit"])) {
  ...
  $tanggal_pembayaran_bulanan = htmlentities(strip_tags(trim($_POST["tanggal_pembayaran_bulanan"] ?? '')));
  ...
  if ($pesan_error === "") {
    ...
    $query = "INSERT INTO `reseller`(`username`, `nama_instansi`, `nama_pemilik`, `email_reseller`, `alamat_instansi`, `no_wa_reseller`, `tanggal_pembayaran_bulanan`) VALUES ";
    $query .= "('$username', '$nama_instansi', '$nama_pemilik', '$email_reseller', '$alamat_instansi', '$no_wa_reseller', '0000-00-00')";

    $result = mysqli_query($conn, $query);  

    //periksa hasil query
    if($result) {
      $query2 = "INSERT INTO `login`(`username`, `password`, `level`) VALUES ";
      $query2 .= "('$username','$password','reseller')";
      ...
      <div class="card-content">
        <form method="post" >
          ...
          <div class="field">
            ...
            <div class="control">
              <input class="input" type="text" name="username" placeholder="budi123" value="<?php echo $username ?>">
            </div>
          </div>
