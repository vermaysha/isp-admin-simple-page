...
$data_reseller = mysqli_query($conn,"SELECT * FROM reseller");
$jumlah_reseller = mysqli_num_rows($data_reseller);
$data_client = mysqli_query($conn,"SELECT * FROM client");
        ...
        <div class="card-content">
          <div class="flex items-center justify-between">
            <div class="widget-label">
              ...
              <h1>
              <?php echo $jumlah_reseller; ?>
              </h1>
            </div>
            <span class="icon widget-icon text-green-500"><i class="mdi mdi-account mdi-48px"></i></span>
          </div>
        </div>
      </div>
      <div class="card">
      ...
      <div class="card">
        <div class="card-content">
          <div class="flex items-center justify-between">
            <div class="widget-label">
              <h3>
                Reseller Dengan Client Terbanyak
              </h3>
              <h1>
                256%
              </h1>
