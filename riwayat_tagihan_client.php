...
if (isset($_POST["hapus"])) {
  ...
  $id = htmlentities(strip_tags(trim($_POST["id_client"])));

  $id = mysqli_real_escape_string($conn, $id);

  $query = "DELETE FROM `riwayat_tagihan` WHERE id_client='$id'";
  $hasil_query = mysqli_query($conn, $query);


  if($hasil_query) {

      header("Location: riwayat_tagihan_client.php");
  }
  else {
      ...
      <div class="card-content">
        <table>
          ...
          <tr>
            ...
            <?php
            $query = "SELECT * FROM `riwayat_tagihan` INNER JOIN `client` ON (riwayat_tagihan.id_client=client.username) WHERE client.id_reseller='$_SESSION[username]' ORDER BY tanggal_bayar DESC ";
            ...
            <td class="actions-cell">
              ...
              <form action="riwayat_tagihan_client.php" method="post" >
                <input type="hidden" name="username" value="<?php echo "$data[id_tagihan]"; ?>" >
