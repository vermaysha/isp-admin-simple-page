...
<section class="is-hero-bar">
  <div class="flex flex-col md:flex-row items-center justify-between space-y-6 md:space-y-0">
    <h1 class="title">
      ...
      <form action="edit_profile_reseller.php" method="post">
              <button class="button blue --jb-modal" data-target="sample-modal" type="submit" name="edit">Edit Profile</button>
      </form>
  </div>
</section>
          ...
          <form>
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="nama_instansi" type="text" placeholder="Global Media Data Prima" value="<?php echo $data['nama_instansi']; ?>" readonly>
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="nama_pemilik" type="text" placeholder="Nama Pemilik" value="<?php echo $data['nama_pemilik']; ?>" readonly>
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="email_reseller" type="text" placeholder="Email" value="<?php echo $data['email_reseller']; ?>" readonly>
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="alamat_instansi" type="text" placeholder="Alamat" value="<?php echo $data['alamat_instansi']; ?>" readonly>
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="no_wa_reseller" type="text" placeholder="Nomor HP" value="<?php echo $data['no_wa_reseller']; ?>" readonly>
                  </div>
                  <p class="help"></p>
                </div>
              </div>
            ...
            <div class="field">
              ...
              <div class="field-body">
                <div class="field">
                  <div class="control">
                  <input class="input" name="tanggal_pembayaran_bulanan" type="date" value="<?php echo $data['tanggal_pembayaran_bulanan']; ?>" readonly>
                  </div>
                  <p class="help"></p>
                </div>
              </div>
      ...
      <div class="card-content">
        <form>
          <div class="field">
            ...
            <div class="control">
              <input type="text" name="password" class="input" value="<?php echo $data['username']; ?>" required readonly>
            </div>
          </div>
          <div class="field">
            <label class="label">Password</label>
            <div class="control">
              <input type="password" name="password_confirmation" class="input" value="<?php echo md5($data['username']); ?>" required readonly>
            </div>
